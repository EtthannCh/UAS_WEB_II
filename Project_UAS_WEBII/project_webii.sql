...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2023 at 07:35 AM
...
CREATE TABLE `tbl_produk` (
  ...
  `COL 2` varchar(116) DEFAULT NULL,
  `COL 3` varchar(11) DEFAULT NULL,
  `COL 4` varchar(9) DEFAULT NULL,
  `COL 5` varchar(234) DEFAULT NULL,
  `COL 6` varchar(15) DEFAULT NULL,
  `COL 7` varchar(479) DEFAULT NULL,
  `COL 8` varchar(4888) DEFAULT NULL,
...
INSERT INTO `tbl_produk` (`COL 1`, `COL 2`, `COL 3`, `COL 4`, `COL 5`, `COL 6`, `COL 7`, `COL 8`, `COL 9`, `COL 10`, `COL 11`, `COL 12`) VALUES
('kode_produk', 'nama_produk', 'id_kategori', 'kode_merk', 'fitur', 'info_tambahan', 'deskripsi_topik', 'deskripsi', 'harga_awal', 'diskon', 'jumlah_produk', 'gambar'),
...
('TH-55JZ950G', 'TH-55JZ950G 55 inch, OLED, 4K HDR Smart TV', '12', 'PNC', 'Dolby Atmos & Dolby Vision|Chromecast built-in?|4K Colour Engine|Android Tv|Multi HDR Format', 'Size:55', 'See it all. Feel it all.|Get more from your TV|Feel the drama unfold with cinematic sound|Put your small screen on your big screen|Optimal brightness and colour - in all conditions|True-to-life picture quality|Beautiful & accurate colours|Stylishly sleek, maximized viewing pleasure', 'Disini. Sekarang. Yang biasa menjadi sinematik. Ini lebih dari sekadar menonton pertunjukan. Ini tentang terpesona. Dibuat oleh pembuat film profesional, hanya TV Android 4K OLED kami yang menghadirkan gambar menakjubkan yang benar-benar membuat Anda takjub. Dengan suara surround 3D untuk membangkitkan semua indera, seolah-olah Anda berada di sana dalam adegan film. Semua teknologi kami dibuat untuk bergerak dan menginspirasi?mengubah keseharian menjadi sinematik.|Android TV - Sederhanakan pengalaman hiburan Anda dengan Android TV. Temukan 400.000+ film dan acara di satu tempat. Minta Asisten Google untuk mengontrol TV Anda dengan suara Anda.|Dolby Atmos? - Sistem audio yang mendukung gambar yang bagus untuk membawa Anda dari sofa ke jantung film. Speaker terintegrasi dan pemrosesan audio bekerja sama dengan teknologi Dolby Atmos? untuk menghadirkan suara yang luar biasa - meningkatkan hiburan ke level baru.|Beralih dari ponsel, tablet, atau laptop ke TV Anda dalam sekejap. Dengan Chromecast built-in?, Anda dapat mentransmisikan semua film, acara, aplikasi, game favorit, dan lainnya langsung ke TV Anda.|Multi HDR Format - Dengan mendukung semua format HDR (High Dynamic Range) TV premium kami memastikan kinerja terbaik - terlepas dari sumber gambarnya. Kecerahan dan warna dioptimalkan adegan demi adegan; apakah sumbernya adalah Dolby Vision, HLG, HDR10 atau format Adaptive HDR10+ yang baru.|4K Colour Engine - Desain untuk meningkatkan pengalaman menonton dengan mengoptimalkan area gelap dan terang untuk menghadirkan pemandangan yang realistis.Teknologi ini juga meningkatkan konten HD/FHD pada resolusi tinggi untuk gambar yang lebih detail.|Hexa Chroma Drive - Menciptakan warna saat ditangkap, secara autentik. Sekarang Anda dapat menikmati film seakurat visi sutradara dan bagaimana film itu dimaksudkan.|Layar besar dalam desain ramping untuk kenikmatan menonton yang maksimal. Gaya minimalis juga melengkapi interior dengan indah.', '26561000', '8805000', '10', 'TH-55JZ950G.png'),
('TH-55JZ1000G', 'TH-55JZ1000G 55 inch, OLED, 4K HDR Smart TV', '12', 'PNC', 'Dolby Atmos & Dolby Vision|Master Hdr|HCX Processor|360?|Big Screen 4K OLED', 'Size:55', 'See it all. Feel it all.|Spectacular cinematic picture performance|Feel the drama unfold with cinematic sound|The intelligent way to a great picture experience|Optimal brightness and colour - in all conditions|Picture perfection for every lighting condition|Home cinema as the director intended, in any light|Intuitive Smart TV|Your life in harmony with your television|Talk to Speaker|Gaming with stunning speed, resolution and motion|Smooth action gaming on the big OLED screen', 'Disini. Sekarang. Yang biasa menjadi sinematik. Ini lebih dari sekadar menonton pertunjukan. Ini tentang terpesona. Dibuat oleh pembuat film profesional, hanya TV Android 4K OLED kami yang menghadirkan gambar menakjubkan yang benar-benar membuat Anda takjub. Dengan suara surround 3D untuk membangkitkan semua indera, seolah-olah Anda berada di sana dalam adegan film. Semua teknologi kami dibuat untuk bergerak dan menginspirasi?mengubah keseharian menjadi sinematik.|Master HDR OLED Panel - TV 4K kami dengan Master HDR OLED Panel mampu menghasilkan warna hitam halus yang lebih dalam untuk nuansa yang lebih sinematik, daripada sebelumnya. Semua berkat puluhan tahun yang dihabiskan untuk membuat televisi berkualitas tinggi, masukan dari ahli warna Hollywood terkemuka dan HCX Pro AI Processor baru kami.|Dolby Atmos? - Sistem audio yang mendukung gambar yang bagus untuk membawa Anda dari sofa ke jantung film. Speaker terintegrasi dan pemrosesan audio bekerja sama dengan teknologi Dolby Atmos? untuk menghadirkan suara yang luar biasa - meningkatkan hiburan ke level baru.|Auto AI - Menggunakan AI, TV premium kami menganalisis sinyal yang masuk dan langsung menyesuaikan karakteristik gambar. Auto AI mengetahui pengaturan untuk olahraga, adegan film, dan lainnya - Jadi Anda bisa duduk santai dan nikmati pertunjukannya.|Multi HDR Format - Dengan mendukung semua format HDR (High Dynamic Range) TV premium kami memastikan kinerja terbaik - terlepas dari sumber gambarnya. Kecerahan dan warna dioptimalkan adegan demi adegan; apakah sumbernya adalah Dolby Vision, HLG, HDR10 atau format Adaptive HDR10+ yang baru.|Dolby Vision? IQ dengan cerdas mengoptimalkan TV Anda untuk mendapatkan gambar sempurna di kamar Anda setiap saat. Apakah ruang tamu Anda benar-benar gelap atau terang benderang, Dolby Vision IQ secara dinamis menyesuaikan dengan perubahan cahaya di dalam ruangan dan memberikan pengalaman menonton terbaik.|Filmmaker mode with intelligent sensing - Brand elektronik dan sutradara film terkemuka menciptakan Filmmaker Mode. Satu tombol menyetel colour-palette, kontras, rasio aspek, dan frame rate seperti yang dibayangkan sutradara. Gambar secara otomatis menyesuaikan meskipun tingkat cahaya berubah.|My Home Screen 6.0 - Akses pengaturan hanya dengan menekan satu tombol. Sematkan favorit, seperti aplikasi streaming video, ke my Home Screen untuk hanya melihat apa yang Anda gunakan.|My Scenery - TV premium baru kami dapat meningkatkan mood Anda bahkan saat tidak menonton secara aktif. Dengan My Scenery, Anda dapat memilih pilihan gambar dan video yang menenangkan, atau mengaturnya sendiri, untuk mencerminkan suasana hati atau waktu Anda. Sempurna untuk sesi mindfulness atau bersiap untuk tidur.|Works with Alexa- Ubah saluran, volume, atau matikan daya dengan suara ? dengan perangkat Amazon Alexa. Ideal saat Anda sedang sibuk.|Game Mode Extreme - Game Mode Extreme berarti TV 4K OLED baru kami siap beraksi. Sementara dukungan HDMI 2.1 dengan High Frame Rates (HFR), Variable Refresh Rate (VRR) dan AMD FreeSync Premium untuk tingkat realisme baru, yang dituntut oleh perangkat game terbaru.|AMD Freesync Premium - TV OLED 2021 kami bersertifikat AMD Freesync Premium. Mereka dirancang untuk mendapatkan pengalaman bermain game terbaik dari perangkat game terbaru dan paling menarik. Nikmati gambar 4K yang halus di layar besar yang penuh warna dan melarikan diri ke dunia game.', '29633000', '6802000', '10', 'TH-55JZ1000G');
