        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <form action="tambah-data.php" enctype="multipart/form-data" method="post">
                        <table>
                            <thead>
                                <tr>
                                    <th>Kode merk</th>
                                ...
                                <tr>
                                    <td><input type="text" name="kode_merk" ></td>
                                    <td><input type="text" name="nama_merk" ></td>
                                    <td><input type="file" name="gambar" value="file" required></td>
                                </tr>
                    ...
                    <a href="brand.php" class="edit">back</a>
                        </form>
                </div><!-- /.container-fluid -->
            </div>
